        ...
        <CardContent className="p-0">
          {isLoading ? (
                  ...
                  <TableRow key={report.id}>
                    ...
                    <TableCell className="text-center pr-6">
                      <Button asChild variant="outline" size="sm">
                        <Link href={`/dashboard/gamas/${report.id}`}><Eye className="mr-2 h-4 w-4" />Lihat Detail</Link>
                      </Button>
                    </TableCell>
                  </TableRow>
                ))}
            ...
            <div className="text-center py-16 px-6">
              ...
              <p className="text-muted-foreground mt-2">Mulai buat laporan eviden gamas pertama Anda.</p>
              <Link href="/dashboard/gamas/new" className="mt-4 inline-block">
                <Button><PlusCircle className="mr-2" />Buat Laporan Baru</Button>
              </Link>
            </div>
          )}
        </CardContent>
